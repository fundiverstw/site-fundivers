  ...
  <div class="pointer-events-none absolute left-2 top-full z-10 flex items-start gap-2 sm:left-4">
    ...
    >
      ...
      >
        ...
        <g fill="#f472a0">
          <path
            d="M30 74c-8 6-12 18-8 30 4-2 7-6 9-12 1 8 0 16-3 22 5-1 9-6 10-14 2-10-2-20-8-26z"
          />
          <path
            d="M46 82c-4 8-4 22 0 32 3-3 5-8 5-15 2 6 2 14 0 20 4-3 6-10 5-18-1-9-6-16-15-19z"
          />
          <path
            d="M90 74c8 6 12 18 8 30-4-2-7-6-9-12-1 8 0 16 3 22-5-1-9-6-10-14-2-10 2-20 8-26z"
          />
