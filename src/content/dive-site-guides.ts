...
export const DIVE_SITE_GUIDES: Record<string, DiveSiteGuide> = {
  ...
  'iron-house-iron-reef': {
    ...
    aboveSurface: 'The views of the shore from Badouzi Bay are lovely.',
    gettingThere:
  ...
  shipwrecks: {
    ...
    aboveSurface: 'Located in Badouzi Bay, the views of the shore and ocean are lovely.',
    gettingThere:
      'The dive boat will depart from Badouzi Harbor. The easiest way to get there is by driving, and plenty of parking is available. There are busses from Keelung that stop nearby as well.',
    requirements: 'Advanced Open Water Divers with Enriched Air Nitrox.',
    highlights: [
  ...
  'iron-house-2': {
    ...
    requirements:
      'Advanced Open Water Divers with Enriched Air Nitrox (Deep Certification Recommended).',
    highlights: [
  ...
  'secret-garden': {
    ...
    highlights: [
      'Dense gorgonian sea fans and whip corals',
      'Vibrant soft-coral gardens',
      'Excellent macro photography',
      'Dramatic Northeast Coast rock terrain',
    ],
    marineLife: [
      'Sea fans (gorgonians)',
      'Soft corals',
  ...
  'bat-cave': {
    ...
    highlights: [
      ...
      'A maze of swim-through rock crevices',
      'Easy, shallow entry with a gradual descent',
      'Great for training and fun dives',
      'Reliable macro life',
    ],
    marineLife: [
      'Nudibranchs',
      ...
      'Octopus',
      'Cuttlefish',
      'Juvenile barracuda (spring–early summer)',
      'Squid',
    ],
    depthRange: '5–16 m',
  ...
  canyons: {
    ...
    highlights: [
      'Dramatic slopes and walls',
      'Boulder swim-throughs',
      'Soft coral and sea fan growth',
      'Sculpted volcanic rock formations',
    ],
    marineLife: [
      'Sea fans (gorgonians)',
      'Soft corals',
  ...
  '82-5': {
    ...
    aboveSurface: 'Beautiful views of the cliffs and ocean are highlights at this site.',
    gettingThere:
    ...
    requirements: 'Advanced Open Water Divers with shore diving experience.',
    highlights: [
      'Roadside marker entry point',
      'Renowned nudibranch and macro wall',
      'Interesting rock formations',
      'Photographer favourite',
    ],
    marineLife: [
      'Nudibranchs',
      'Moray eels',
  ...
  'long-dong-bay': {
    ...
    highlights: [
      'Easy walk-in ramp entry',
      'Sheltered, protected bay',
      'Suitable for all levels',
      'Abundant coral and reef fish',
    ],
    marineLife: [
      'Nudibranchs',
      'Moray eels',
  ...
  'cauliflower-garden': {
    ...
    aboveSurface: 'The view of the coastline and rock formations are great from the boat',
    gettingThere:
      'We will board the dive boat at Aodi Fishing Harbor. Driving is the easiest way to get there and parking is available. There are busses that get there from both Keelung and Taipei, but the distance and time required makes it not worth it.',
    requirements: 'Advanced Open Water Divers with Enriched Air Nitrox.',
    highlights: [
      'Vertical wall draped in cauliflower-shaped soft corals',
      'Vivid coral colours and reef textures',
      'Nitrox extends bottom time on the wall',
      'Nudibranch and macro hunting in the crevices',
    ],
    marineLife: [
  ...
  'turtle-island': {
    ...
    highlights: [
      'Diving inside an active underwater hot spring',
      'Milky turquoise “Milk Sea” sulfur plumes',
      'Endemic Xenograpsus vent crabs',
      'Warm volcanic bubbles rising from the seabed',
      'Sharks reported near the vents',
    ],
    marineLife: [
      'Xenograpsus vent crabs',
      'Reef sharks (reported near vents)',
      'Schooling reef fish',
      'Jacks and trevally',
      'Moray eels',
      'Pelagic fish drawn by the Kuroshio',
      'Damselfish',
      'Crustaceans',
    ],
    depthRange: '5–30 m',
  ...
  cathedral: {
    ...
    aboveSurface: 'The views of the coastline and ocean from the boat are lovely.',
    gettingThere:
      'We will board the dive boat at Aodi Fishing Harbor. Driving is the easiest way to get there and parking is available. There are busses that get there from both Keelung and Taipei, but the distance and time required makes it not worth it.',
    requirements: 'All levels.',
    highlights: [
      'Suitable for all certification levels',
      'Reef full of surprises and passing schools',
      'Sea fans and soft corals',
      'Great for relaxed exploration and macro',
    ],
    marineLife: [
      'Schooling reef fish',
      'Jacks and trevally',
  ...
  'wan-an-jian-navy-wreck': {
    ...
    requirements:
      'Advanced Open Water Divers with Enriched Air Nitrox (Deep Certification Recommended).',
    highlights: [
      'A navy ship sunk as an artificial reef',
      'Huge wreck teeming with schooling fish',
      'Port side blanketed in whip and black corals',
      'Open deck sections for experienced divers',
      'Deep + Nitrox recommended for bottom time',
    ],
    marineLife: [
      'Amberjacks',
      'Chicken grunts',
  ...
  'green-island': {
    ...
    highlights: [
      'The 1,000-year-old “Big Mushroom” coral',
      'Exceptional 30–40 m visibility',
      'Zhaori seawater hot spring',
      'Winter hammerhead chances',
      '20+ Kuroshio-fed dive sites',
    ],
    marineLife: [
      'Green sea turtles',
      'Seahorses',
      'Hard corals (Porites, tube coral)',
      'Scalloped hammerhead sharks (winter)',
      'Damselfish',
      'Butterflyfish',
      'Moray eels',
      'Nudibranchs',
  ...
  'orchid-island': {
    ...
    highlights: [
      'The deep Badai Wreck (26–40 m)',
      '30–50 m year-round visibility',
      'Pelagics and drift walls',
      'Tao/Yami indigenous culture',
      'Uncrowded, advanced diving',
    ],
    marineLife: [
      'Trevally and jacks',
      'Barracuda',
  ...
  'lambai-island': {
    ...
    requirements:
      'Open water diver (Advanced certification and SMB are recommended for all boat diving).',
    highlights: [
      'Near-guaranteed green turtle encounters',
      'Warm water and easy year-round diving',
      'Taiwan’s only inhabited coral island',
      'Gentle reef slopes for all levels',
  ...
  kenting: {
    ...
    requirements:
      'Open water diver (Advanced certification and SMB are recommended for all boat diving).',
    highlights: [
      'Coral-plastered reefs and pinnacles at Nanwan',
      'Shallow Houbihu shore diving',
      'The warm Chushuikou outflow site',
      'Year-round diving, best autumn/winter',
  ...
  penghu: {
    ...
    highlights: [
      'Taiwan’s richest fish life',
      'South Penghu Marine National Park (250+ fish species)',
      'World-class drift diving',
      'Barracuda and surgeonfish schools',
      'Clear summer visibility',
    ],
    marineLife: [
  ...
  malapascua: {
    ...
    requirements: 'Advanced Open Water Divers with Enriched Air Nitrox.',
    highlights: [
      'Thresher sharks at Monad Shoal year-round',
      'Gato Island swim-throughs and sea snakes',
      'Tiger and whale shark chances at Kimud Shoal',
      'Quiet, relaxed island atmosphere',
      'Cruising the archipelago between dives',
    ],
    marineLife: [
      'Thresher sharks',
      'Tiger sharks',
  ...
  'puerto-galera': {
    ...
    highlights: [
      ...
      'Deep specialty opens the best sites',
    ],
    marineLife: [
      'Sea turtles',
      'Jackfish',
  ...
  'panglao-bohol': {
    ...
    requirements:
      'AOW Certification recommended so you can visit some of the deeper sites. However, there several sites that are accessible to OW certified divers.',
    highlights: [
      'Napaling Reef sardine ball',
      'Balicasag Island marine sanctuary',
      'Pamilacan Island turtles and rays',
      'Dolphin and whale shark chances',
      'Quiet beaches between dives',
    ],
    marineLife: [
      'Sardine schools',
      'Jackfish',
  ...
  anilao: {
    ...
    highlights: [
      ...
      'Secret Bay muck site',
      'Matu Point drop-offs and pelagics',
