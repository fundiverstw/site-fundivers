...
export const QUESTIONS: Question[] = [
  // ── Physics ───────────────────────────────────────────────────────────────
  {
    ...
    explain: 'Every 10 m of seawater adds 1 bar. At 10 m you are at 2 bar absolute — double the surface pressure.',
  },
  {
    category: 'Physics',
    ...
    explain: '30 m is 4 bar absolute. Boyle’s law: volume is inversely proportional to pressure, so 4 L ÷ 4 = 1 L.',
  },
  {
    category: 'Physics',
    q: 'Which colour disappears first as you descend?',
    answers: ['Red', 'Blue', 'Green', 'Violet'],
    explain: 'Red has the longest wavelength and is absorbed within the first few metres. That is why blood looks green at depth.',
  },
  {
    category: 'Physics',
    q: 'Looking through your mask, objects underwater appear roughly…',
    answers: ['33% larger and 25% closer', '33% smaller and 25% further', 'Exactly as they are', 'Twice as large'],
    explain: 'Light bends as it passes from water to the air in your mask, magnifying everything by about a third.',
  },
  {
    category: 'Physics',
    q: 'Compared with air, sound travels through water…',
    answers: ['About four times faster', 'About four times slower', 'At the same speed', 'It does not travel at all'],
    explain: 'Roughly 1,500 m/s versus 340 m/s. It arrives at both ears almost at once, which is why sound underwater seems to come from everywhere.',
  },
  {
    category: 'Physics',
  ...
  },
  {
    ...
    answers: ['21% oxygen, 79% nitrogen', '50% oxygen, 50% nitrogen', '100% oxygen', '79% oxygen, 21% nitrogen'],
    explain: 'Ordinary air. The nitrogen does nothing for you metabolically, but it is the gas that drives decompression theory.',
  },
  {
    category: 'Physics',
    ...
    explain: 'At 20 m each lungful holds three times as many molecules as at the surface — so your cylinder drains about three times as fast.',
  },
  ...
  // ── Physiology ────────────────────────────────────────────────────────────
  {
    ...
    explain: 'Breathe continuously. Holding your breath while ascending lets expanding air rupture your lung tissue.',
  },
  {
    category: 'Physiology',
    q: 'Nitrogen narcosis typically becomes noticeable below about…',
    answers: ['30 metres', '5 metres', '10 metres', '60 metres'],
    explain: 'Sometimes called "the martini effect". It clears completely and immediately as you ascend.',
  },
  {
    category: 'Physiology',
    ...
    explain: 'Ascend slowly and the nitrogen leaves your tissues through your lungs. Ascend fast and it fizzes out like an opened bottle.',
  },
  {
    category: 'Physiology',
    ...
    explain: 'The proportional pressure change is greatest near the surface — air doubles in volume between 10 m and 0 m.',
  },
  {
    category: 'Physiology',
    ...
    explain: 'Optional on a no-stop dive, but always a good idea. It gives dissolved nitrogen extra time to leave your tissues.',
  },
  {
    category: 'Physiology',
    q: 'The maximum ascent rate recommended by PADI is…',
    answers: ['18 metres per minute', '30 metres per minute', '10 metres per minute', 'As slow as your air allows'],
    explain: 'About the speed of your smallest bubbles rising. Slower is always fine; faster is not.',
  },
  {
    category: 'Physiology',
    ...
    explain: 'Once it hurts, the tissue is already swelling and equalising gets harder. Stay ahead of it.',
  },
  {
    category: 'Physiology',
    ...
    explain: 'The fix is the same as the cause: descend a little, let it clear, and come up slowly.',
  },
  {
    category: 'Physiology',
    ...
    explain: '1.6 bar is treated as a contingency ceiling. Beyond it, central-nervous-system oxygen toxicity becomes a real risk.',
  },
  {
    category: 'Physiology',
    ...
    explain: 'A single no-stop dive calls for 12 hours. Repetitive or multi-day diving calls for 18.',
  },
  {
    category: 'Physiology',
    ...
    explain: 'More oxygen means less nitrogen — but oxygen becomes toxic under pressure, so nitrox has a maximum operating depth.',
  },
  ...
  // ── Equipment ─────────────────────────────────────────────────────────────
  {
    ...
    explain: 'Usually on a bright yellow hose so a diver in trouble can find it without being told.',
  },
  {
    category: 'Equipment',
    ...
    explain: 'The second stage — the bit in your mouth — then drops that intermediate pressure to ambient, on demand.',
  },
  {
    category: 'Equipment',
    ...
    explain: 'This is why fit matters. A loose suit flushes cold water through and you lose the layer you just warmed.',
  },
  {
    category: 'Equipment',
    ...
    explain: 'Always analyse a nitrox cylinder yourself and sign for it. The band tells you to check; it does not tell you the mix.',
  },
  {
    category: 'Equipment',
    ...
    explain: 'Delayed Surface Marker Buoy. Sent up from depth so the boat knows where you will pop up, especially on a drift.',
  },
  {
    category: 'Equipment',
  ...
  },
  {
    ...
    explain: 'Water pushed past the second-stage valve travels up the hose into the first stage, where it will corrode things quietly.',
  },
  {
    category: 'Equipment',
    ...
    explain: 'Buoyancy Control Device. Good divers use their lungs for fine adjustments and the BCD for coarse ones.',
  },
  ...
  // ── Safety ────────────────────────────────────────────────────────────────
  {
    ...
    explain: 'Begin With Review And Friend, Burger With Relish And Fries — whatever you need to remember it.',
  },
  {
    category: 'Safety',
    ...
    explain: 'A minute, then up. Two divers surfacing separately is a nuisance; two divers searching for each other at depth is a problem.',
  },
  {
    category: 'Safety',
    ...
    explain: 'A fist to the chest means low on air. A hand across the throat means it is already gone — the difference matters.',
  },
  {
    category: 'Safety',
    q: 'In diving, a thumbs-up signal means…',
    answers: ['Let’s ascend / end the dive', 'Everything is fine', 'I am low on air', 'Look over there'],
    explain: '"OK" is thumb and forefinger in a circle. Never use a thumbs-up to mean "good" underwater.',
  },
  {
    category: 'Safety',
  ...
  },
  {
    ...
    explain: 'A free-flowing reg is still giving you air. Let it spill from the corner of your mouth, breathe from the flow, and end the dive.',
  },
  {
    category: 'Safety',
    ...
    explain: 'The red flag with the white diagonal is the North American "diver down" flag. Alpha is the international one.',
  },
  ...
  },
  {
    ...
    explain: 'It looks menacing and it is simply breathing. Morays only bite when a hand goes where it should not.',
  },
  {
    category: 'Marine Life',
    ...
    explain: 'Swimming up to escape keeps you inside the cone. Swim flat and away, and keep your fins between you and the fish.',
  },
  {
    category: 'Marine Life',
    ...
    explain: 'The anemone gets cleaned and defended in return. Neither party could thrive as well alone.',
  },
  {
    category: 'Marine Life',
    q: 'Which of these has eight arms plus two longer feeding tentacles?',
    answers: ['Cuttlefish', 'Octopus', 'Nudibranch', 'Sea star'],
    explain: 'The octopus has eight arms and nothing else. The cuttlefish shoots those two extra tentacles out to snatch prey.',
  },
  {
    category: 'Marine Life',
    ...
    explain: 'When stressed coral expels those algae it loses both its colour and its food supply. That is bleaching.',
  },
  {
    category: 'Marine Life',
    q: 'An adult green sea turtle eats mainly…',
    answers: ['Seagrass and algae', 'Jellyfish', 'Small fish', 'Coral polyps'],
    explain: 'They are the only largely herbivorous sea turtle as adults — and the green refers to their body fat, not their shell.',
  },
  {
    category: 'Marine Life',
  ...
  // ── Taiwan & FunDivers ────────────────────────────────────────────────────
  {
    ...
    explain: 'Guishan Island is the tip of Taiwan’s only active volcano. Its sulfur plumes turn the sea a milky turquoise.',
  },
  {
    category: 'Taiwan',
  ...
  },
  {
    ...
    answers: ['Over a thousand years', 'About fifty years', 'About two hundred years', 'Over ten thousand years'],
    explain: 'A Porites coral head some 10 m tall, and among the largest living corals anywhere on Earth.',
  },
  {
    category: 'Taiwan',
    ...
    explain: 'You park at the marker and walk in. It is also one of the few places in Taiwan to find the "Pikachu" nudibranch.',
  },
  {
    category: 'Taiwan',
    ...
    explain: 'The Longmen plant was finished in 2014 but never switched on. Divers call it the most expensive dive site in the world.',
  },
  {
    category: 'Taiwan',
  ...
  },
  {
    ...
    explain: 'Taiwan’s fish factory. Strong steady currents, barracuda walls, and a season that closes when the monsoon arrives.',
  },
  {
    category: 'Taiwan',
    ...
    explain: 'Underwater, the site is a maze of rock crevices wide enough to swim through. The bats are strictly an above-the-surface attraction.',
  },
  {
    category: 'Taiwan',
    ...
    explain: 'They rise to Monad Shoal at first light to be cleaned by wrasse — nearly every morning of the year.',
  },
  {
    category: 'Taiwan',
    q: 'Blue Corner, regularly called one of the best dive sites on Earth, is in…',
    answers: ['Palau', 'Bohol', 'Anilao', 'Puerto Galera'],
    explain: 'A dramatic drop-off swept by current, where divers hook in and watch the pelagics stream past.',
  },
]
