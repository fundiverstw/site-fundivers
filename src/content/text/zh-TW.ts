...
export const zhTW: Dict = {
  ...
  getInTouch: {
    ...
    dsd: 'PADI 體驗水肺潛水（DSD）',
    dsdDesc:
      '體驗潛水讓你不需要任何訓練，就能親身感受潛水。所有事情都由持證潛水教練打理，你只要專心感受第一次在水下呼吸。',
    requestCourse: '報名課程諮詢',
    coursesDesc:
      'PADI 課程從第一張證照一路到專業等級。告訴我們你想上哪一門，我們會安排適合你行程的日期。',
    name: '姓名',
    email: '電子郵件',
    people: '人數',
    availableFrom: '方便的日期（開始）',
    availableTo: '方便的日期（結束，可不填）',
    request: '您的需求',
    requestPlaceholder: '潛水經驗、住宿地點，或其他想讓我們知道的事…',
    cancel: '取消',
    send: '送出需求',
