...
export const COURSE_GUIDES: Record<string, CourseGuide> = {
  "padi-open-water-course": {
    "overview": "The PADI Open Water Diver course is your first full scuba certification and the most popular dive course in the world. Across knowledge sessions, confined-water practice and four open-water dives, you learn everything you need to dive independently with a buddy — anywhere on Earth.",
    "youWillLearn": [
  ...
  "padi-advanced-course": {
    "overview": "Ready for more? Advanced Open Water builds your skills over five “adventure” dives — a Deep dive and an Underwater Navigation dive plus three of your choice. It's the fastest way to gain experience under instructor guidance and extends your depth limit to 30 metres.",
    "youWillLearn": [
  ...
  "padi-rescue-diver-course": {
    "overview": "Often called the most challenging — and most rewarding — PADI course, Rescue Diver teaches you to prevent and manage dive emergencies for yourself and others. You'll finish a far more confident, aware and capable diver.",
    "youWillLearn": [
    ...
    "prerequisites": "PADI Adventure Diver (with Navigation) or higher, plus EFR training within 24 months",
    "minAge": "12+",
    "duration": "3–4 days",
    "depth": null,
  ...
  "padi-divemaster-course": {
    "overview": "The Divemaster course is your first step into professional diving. Working closely with our instructors you develop dive-leadership skills, supervise activities and assist with student divers — the start of a career in the water.",
    "youWillLearn": [
  ...
  "padi-master-scuba-diver": {
    "overview": "PADI Master Scuba Diver is the highest non-professional rating — a mark of experience and versatility that fewer than two percent of divers reach. It recognises those who have earned a breadth of certifications and logged real experience.",
    "youWillLearn": [
  ...
  "padi-discover-scuba-diving-program": {
    "overview": "Never dived before? Discover Scuba Diving lets you try scuba under the direct supervision of a PADI Professional — no certification required. It's the perfect first taste, and your dives can later count toward your Open Water certification.",
    "youWillLearn": [
  ...
  "padi-refresher-course": {
    "overview": "Been out of the water for a while? A refresher rebuilds your skills and confidence so you can get back to diving safely — ideal if it's been a year or more since your last dive.",
    "youWillLearn": [
  ...
  "padi-efr-course": {
    "overview": "Emergency First Response teaches the same CPR and first-aid skills the professionals use, in an approachable way for anyone. It's the prerequisite for Rescue Diver — and valuable far beyond diving.",
    "youWillLearn": [
      "Primary care (CPR)",
  ...
  "padi-o2-provider-course": {
    "overview": "Emergency oxygen is a key part of caring for an injured diver. This course teaches you to recognise the dive injuries where oxygen helps and to administer emergency O2 safely and effectively.",
    "youWillLearn": [
  ...
  "padi-enriched-air-specialty-course": {
    "overview": "Enriched Air (Nitrox) is the most popular PADI specialty. Breathing more oxygen and less nitrogen lets you extend your no-stop bottom times — more time exploring, and shorter surface intervals between dives.",
    "youWillLearn": [
  ...
  "padi-deep-diver-specialty": {
    "overview": "Some of the most exciting dives — wrecks, walls and big animals — lie beyond 18 metres. The Deep Diver specialty teaches you to plan and safely enjoy dives down to 40 metres, the recreational limit.",
    "youWillLearn": [
  ...
  "padi-night-diver-specialty": {
    "overview": "The reef transforms after dark. The Night Diver specialty builds the skills and confidence to explore the underwater world at night, when nocturnal creatures emerge and familiar sites feel brand new.",
    "youWillLearn": [
  ...
  "padi-search-recovery-specialty": {
    "overview": "Lost something underwater, or want the skills to find and recover objects safely? The Search & Recovery specialty teaches proven search patterns and lifting techniques to locate and raise lost items.",
    "youWillLearn": [
  ...
  "padi-drift-diver-specialty": {
    "overview": "Drift diving feels like flying — letting the current carry you effortlessly over reefs and walls. This specialty teaches the technique and awareness to make current your friend.",
    "youWillLearn": [
  ...
  "padi-peak-performance-buoyancy-specialty": {
    "overview": "Great divers make it look effortless — hovering motionless, gliding past delicate corals, using less air. Peak Performance Buoyancy fine-tunes your weighting and control so you dive like a pro.",
    "youWillLearn": [
  ...
  "padi-underwater-navigator-specialty": {
    "overview": "Never lose your way — or the boat — again. The Underwater Navigator specialty sharpens your natural and compass navigation so you can explore with confidence and always find your way back.",
    "youWillLearn": [
  ...
  "padi-boat-diver-specialty": {
    "overview": "From small RIBs to liveaboards, boats open up the best dive sites. The Boat Diver specialty makes you comfortable and competent diving from boats of every kind.",
    "youWillLearn": [
  ...
  "padi-equipment-specialist": {
    "overview": "Understand the gear that keeps you alive underwater. The Equipment Specialist course — no dives required — teaches routine care, maintenance and simple field adjustments so a minor problem never ends your dive day.",
    "youWillLearn": [
  ...
  "padi-digital-underwater-photographer-specialty": {
    "overview": "Bring home the underwater world. This specialty gets you shooting great photos and video fast, using the PADI approach to composition, camera settings and getting close to your subject.",
    "youWillLearn": [
  ...
  "padi-fish-identification-specialty": {
    "overview": "Turn “what was that fish?” into instant recognition. The Fish Identification specialty teaches you the major fish families and how to identify the species you meet on every dive.",
    "youWillLearn": [
...
export function sessionMatchesCourse(guide: CourseGuide | undefined, category: string | null): boolean {
