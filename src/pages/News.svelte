<script lang="ts">
  ...
  // The Logbook feed, served at /logbook. `news` is the
  ...
  //
  // The full write-up lives at /logbook/<slug> (NewsArticle.svelte). A card shows
        ...
        >
          ...
          <div class="flex flex-1 flex-col p-5">
            ...
            <h2 class="mt-2 text-t2 font-bold text-white">
              ...
              <a href={`/logbook/${article.slug}`} class="after:absolute after:inset-0"
                >{text.title}</a
              >
            </h2>
